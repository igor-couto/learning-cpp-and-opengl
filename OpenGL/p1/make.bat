...
set "lib_glew=-L..\glew-2.0.0\lib\Release\Win32"
...
:compile
g++ main.cpp --std=c++14 -Wall -I..\SDL2-2.0.5\i686-w64-mingw32\include\SDL2 -L..\SDL2-2.0.5\i686-w64-mingw32\bin -L..\SDL2-2.0.5\i686-w64-mingw32\lib -I..\glm-0.9.8.4\glm -L..\glew-2.0.0\lib\mingw32 -lmingw32 -lSDL2main -lSDL2 -lglew32 -opengl -o main